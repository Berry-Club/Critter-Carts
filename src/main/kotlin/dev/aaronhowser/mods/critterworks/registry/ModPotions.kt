...
import dev.aaronhowser.mods.critterworks.item.DyeberryItem
...
object ModPotions {
	...
	val POTION_REGISTRY: DeferredRegister<Potion> =
		DeferredRegister.create(Registries.POTION, Critterworks.MOD_ID)
	...
	private fun register(
		...
		return POTION_REGISTRY.register(name, Supplier {
			Potion(Critterworks.MOD_ID + "." + name, effect())
		})
	}
