...
object ModMenuLang {
	...
	fun add(provider: ModLanguageProvider) {
		...
		provider.add("menu.critter_carts.spider_nest.title", "Hopping Spiders")
		provider.add("menu.critter_carts.spider_nest.spider", "Spider %s")
		provider.add("menu.critter_carts.spider_nest.position", "Position: %s, %s, %s")
		provider.add("menu.critter_carts.spider_nest.idle", "Job: Idle")
		provider.add("menu.critter_carts.spider_nest.collecting", "Job: Collecting %s items")
		provider.add("menu.critter_carts.spider_nest.delivering", "Job: Delivering %s")
		provider.add("menu.critter_carts.spider_nest.waiting", "Job: Waiting (%s)")
		provider.add("menu.critter_carts.spider_nest.returning_item", "Job: Returning item (%s)")
		provider.add("menu.critter_carts.spider_nest.returning", "Job: Returning to nest")
		provider.add("menu.critter_carts.spider_nest.failure.destination_missing", "destination missing")
		provider.add("menu.critter_carts.spider_nest.failure.source_missing", "source missing")
		provider.add("menu.critter_carts.spider_nest.failure.destination_not_output", "output disabled")
		provider.add("menu.critter_carts.spider_nest.failure.channel_changed", "channel changed")
		provider.add("menu.critter_carts.spider_nest.failure.filter_changed", "filter changed")
		provider.add("menu.critter_carts.spider_nest.failure.destination_unavailable", "inventory unavailable")
		provider.add("menu.critter_carts.spider_nest.failure.destination_full", "destination full")
